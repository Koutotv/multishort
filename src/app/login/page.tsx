...
export default function LoginPage() {
  ...
  const handleProviderLogin = async (provider: "google" | "discord") => {
    setError("");
      ...
      <div className="hidden w-1/2 flex-col justify-between bg-gradient-to-br from-violet-600 to-indigo-700 p-12 lg:flex">
        ...
        <div>
          ...
          <p className="mt-4 text-violet-200">
            Connectez vos plateformes et gagnez des heures chaque semaine.
          </p>
        </div>
        <p className="text-sm text-violet-300">
          Mode démo — utilisez n&apos;importe quel email valide
        </p>
      </div>
      ...
      <div className="flex w-full flex-col justify-center px-6 py-12 lg:w-1/2 lg:px-16">
        <div className="mx-auto w-full max-w-sm">
          ...
          <div className="mt-8 space-y-4">
            <SocialAuthButtons onProviderClick={handleProviderLogin} />
